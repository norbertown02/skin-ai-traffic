...
function diagnose(item, benchmark){
  const m=item?.metrics||{}, ctr=n(m.ctr), roas=n(m.roas), purchases=n(m.purchases), spend=n(m.spend)
  ...
  return <div className="page pro-page creatives-page">
    ...
    {selected && <div className="creative-detail-backdrop" onMouseDown={e => e.target === e.currentTarget && setSelected(null)}>
      <section className="creative-detail-shell">
        <header className="creative-detail-topbar"><div><span>ANÁLISE DO CRIATIVO</span><strong>{selected.name||'Criativo'}</strong></div><button onClick={()=>setSelected(null)}>Fechar ×</button></header>
        ...
        <div className="creative-detail-hero">
          ...
          <div className="creative-detail-summary">
            ...
            <h2>{selected.headline||selected.name||'Criativo'}</h2>
